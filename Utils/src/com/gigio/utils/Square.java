...
public class Square
{
	...
	public Square(final float side, final float[] color)
	{
		this.color = color;

		final float vertices[] = { -side, side, 0.0f, // 0, Top Left
				-side, -side, 0.0f, // 1, Bottom Left
				side, -side, 0.0f, // 2, Bottom Right
				side, side, 0.0f, // 3, Top Right
		};
